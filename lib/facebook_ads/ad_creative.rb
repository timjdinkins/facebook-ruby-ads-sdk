module FacebookAds
  ...
  class AdCreative < Base
    ...
    class << self
      ...
      def photo( name:, page_id:, instagram_actor_id: nil, message:, link:, app_link: nil, link_title:, image_hash:, call_to_action_type:, link_description: nil, url_tags: nil, attachment_style: nil, caption: nil )
        object_story_spec = {
          'page_id' => page_id,
